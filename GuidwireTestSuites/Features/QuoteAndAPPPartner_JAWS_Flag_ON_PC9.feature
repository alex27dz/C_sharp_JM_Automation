Feature: QuoteAndAPPPartner_JAWS_Flag_ON_PC9
 ...
 @STP 
	@regression
                ...
                And I enter <GW_UserName> and <GW_Password> on the BC Login page
                ...
                | QP                     | desktop    |            | Chrome      |                 | QAPMGolden | STP      | 48 Jewelers Park Dr |           | Neenah | Wisconsin | 54956          | Yes              | 9205352871  | rparas@jminsure.com | Email             | FeMale | PrimaryApplicant | No                    | No                       | Yes           | No               | currentdate   | Z100D20      | Yes                 |                      | Agency Express       | REGISTRY         | 05/01/1977    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw         | Annual Pay    | REGISTRY     | visa ****8291        | Yes     | In Force        | No                 |
 @NonSTP 
@regression
                Scenario Outline: 02_QAPMGEICO_NonSTP_to38kWithAppraisalsFred
                Given I access the QuoteAndApp app in <ApplicationEnvironment> , <TargetType> , <Capability> , <BrowserType> and <OperatingSystem>
                When I login to partner mode
                | UserName                 | Password |
                ...
                | QP                     | desktop    |            | Chrome      |                 | QIMGolden | NonSTP   | 302 Millers Xing | Ste 11    | Harker Heights | Texas | 76548          | Yes              | 2025352871  | rparas@jminsure.com | Email             | FeMale | PrimaryApplicant | No                    | No                       | Yes           | No               | currentdate   | Z100D40      | Yes                 |                      | Agency Express       | REGISTRY         | 05/01/1977    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw         | Quoted       | Approval Needed - Item Value Exceeds Underwriting Guidelines: Item #1;Approval Needed: Agency Rule 4 - Item #1 >$25,000 | No                 | Web New Sub w/issues |
              ...
              And I Enter qualification questions <MinorTrafficViolation> , <LossTheftDamageToJewelry> on Applicant and Wearer page
                ...
                Examples:
                | ApplicationEnvironment | TargetType | Capability | BrowserType | OperatingSystem | FirstName | LastName | Address             | Apartment | City   | State     | AddressZipCode | IsMailingAddress | PhoneNumber | EmailAddress         | ContactPreference | Gender | WearerType | MinorTrafficViolation | LossTheftDamageToJewelry | PrivacyPolicy | AlarmAndSecurity | EffectiveDate | ProducerCode | GWPaperlessDelivery | GWApplicationTakenBy | GWDistributionSource | GWPrimaryInsured | GWDateofBirth | GWOccupation | GWAddressType | GWStatus | GWAddress | AccountNumber | GW_UserName | GW_Password | GWPaymentPlan | GWExpireDate | GWPayment_Instrument | AutoPay | GW_PolicyStatus | TermsAndConditions |
                | QP                     | desktop    |            | Chrome      |                 | Golden4   | NonSTP   | 48 Jewelers Park Dr |           | Neenah | Wisconsin | 54956          | Yes              | 9205352871  | rparas@jminsure.com | Email             | Male   | wearer     | No                    | No                       | Yes           | No               | currentdate   | Z100D20      | Yes                 |                      | Agency Express       | REGISTRY         | 07/01/1966    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw         | Annual Pay    | REGISTRY     | visa ****8291        | Yes     | In Force        | No                 |
                ...
                | QP                     | desktop    |            | Chrome      |                 | Golden5   | NonSTP   | 1250 14th St |           | Denver | Colorado | 80202          | No               | 9205352871  | rparas@jminsure.com | Email             | FeMale | wearer     | No                    | No                       | Yes           | No               | currentdate   | Z100D20      | Yes                 |                      | Agency Express       | REGISTRY         | 07/01/1966    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw         | Quoted       | Approval Needed - Item Value Exceeds Underwriting Guidelines: Item #1;Total Schedule Exceeds $50,000;Approval Needed: Agency Rule 4 - Item #1 >$25,000 | Schedule Exceeds UW Guidelines |
                ...
                | QP                     | desktop    |            | Chrome      |                 | Golden6   | NonSTP   | 24 Jewelers Park Dr |           | Neenah | Wisconsin | 54956          | Yes              | 9205352871  | rparas@jminsure.com | Email             | Female | felony                | No                       | Yes           | No               | currentdate   | Z100D20      | Yes                 |                      | Agency Express       | REGISTRY         | 07/01/1966    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw         | Quoted       | Approval Needed - Applicant convicted of a felony | No                 |Web New Sub w/issues              |


               @NonSTP 
               @regression
                Scenario Outline: 06_QAPMGEICO_NonSTP_lessthen16K LossGreaterthen25K_Fred
                Given I access the QuoteAndApp app in <ApplicationEnvironment> , <TargetType> , <Capability> , <BrowserType> and <OperatingSystem>
                When I login to partner mode
                | UserName                 | Password |
                | double@produceracess.com | Rose*#12 |
...
                | 12/10/2016 | Theft | 4001      |
                ...
                Examples:
                | ApplicationEnvironment | TargetType | Capability | BrowserType | OperatingSystem | FirstName | LastName | Address             | Apartment | City   | State     | AddressZipCode | IsMailingAddress | PhoneNumber | EmailAddress         | ContactPreference | Gender | MinorTrafficViolation | LossTheftDamageToJewelry | PrivacyPolicy | AlarmAndSecurity | EffectiveDate | ProducerCode | GWPaperlessDelivery | GWApplicationTakenBy | GWDistributionSource | GWPrimaryInsured | GWDateofBirth | GWOccupation | GWAddressType | GWStatus | GWAddress | AccountNumber | GW_UserName | GW_Password | PolicyStatus | Activities                     | TermsAndConditions | PCActivities |
                | QP                     | desktop    |            | Chrome      |                 | Golden7   | NonSTP   | 24 Jewelers Park Dr |           | Neenah | Wisconsin | 54956          | Yes              | 9205352871  | rparas@jminsure.com | Email             | Female | No                    | Yes                      | Yes           | No               | currentdate   | Z100D40      | Yes                 |                      | Agency Express       | REGISTRY         | 07/01/1966    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw         | Quoted       | Loss or Claim Activity | No                 | Submission with issues      |
			...
			@regression
                ...
                When I login to partner mode
                | UserName           | Password |
                | Regression_TWFG@test-jminsure.com | Pass1234 |
				And I select Agency
				| Agency                |
				| elopes oops (TW144) |
				And I Enter <FirstName> , <LastName> , <PhoneNumber> , <EmailAddress>  in the Quote Page Details for Partner Mode
                ...
                | Checking | USA     | You have successfully completed your application for jewelry insurance. Thank you for choosing Jewelers Mutual Insurance Group to protect your jewelry and the precious moments it represents. |
			    And I access the Guidewire PC on Desktop in IE
               	And I enter <GW_UserName> and <GW_Password> on the PC9 Login page
				And I select Policies from the Search Tab menu of PC9
				And search for account with <AccountNumber> and select from search results in PC9 
                ...
                Examples:
                | ApplicationEnvironment | TargetType | Capability | BrowserType | OperatingSystem | FirstName  | LastName | Address             | Apartment | City   | State     | AddressZipCode | IsMailingAddress | PhoneNumber | EmailAddress                 | ContactPreference | Gender | WearerType       | MinorTrafficViolation | LossTheftDamageToJewelry | PrivacyPolicy | AlarmAndSecurity | EffectiveDate | ProducerCode | GWPaperlessDelivery | GWApplicationTakenBy | GWDistributionSource | GWPrimaryInsured | GWDateofBirth | GWOccupation | GWAddressType | GWStatus | GWAddress | AccountNumber | GW_UserName | GW_Password | GWPaymentPlan | GWExpireDate | GWPayment_Instrument | AutoPay | GW_PolicyStatus | TermsAndConditions |
                | QP                     | desktop    |            | Chrome      |                 | QAPMGolden | STP      | 48 Jewelers Park Dr |           | Neenah | Wisconsin | 54956          | Yes              | 9205352871  | rparas@jminsure.com | Email             | FeMale | PrimaryApplicant | No                    | No                       | Yes           | No               | currentdate   | TW144        | Yes                 |                      | Agency Express       | REGISTRY         | 05/01/1977    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw          | Annual Pay    | REGISTRY     | checking ****3332     | Yes     | In Force        | No                 |
...
                | 12/10/2016 | Theft | 4001      |
				...
				And I verify <GWDistributionSource> , <ContactPreference> , <GWApplicationTakenBy> , <GWPaperlessDelivery> , <ProducerCode> in Right Account Details page for PC9 for QNA Account
				And I verify Activity  <PCActivities> in PC9
				And I verfy <PolicyStatus> , 02/08/2022 in Policy Term  for WorkOrders in PC9  
				And I click workorder number of Account detail screen in PC9
				And I click on RiskAnalysis on Left NavMenu Screen in PC9
				And I verify <Activities> in the Risk Analysis screen in PC9
				And I logout of the PC9 application 
                ...
                Examples:
                | ApplicationEnvironment | TargetType | Capability | BrowserType | OperatingSystem | FirstName | LastName | Address             | Apartment | City   | State     | AddressZipCode | IsMailingAddress | PhoneNumber | EmailAddress         | ContactPreference | Gender | MinorTrafficViolation | LossTheftDamageToJewelry | PrivacyPolicy | AlarmAndSecurity | EffectiveDate | ProducerCode | GWPaperlessDelivery | GWApplicationTakenBy | GWDistributionSource | GWPrimaryInsured | GWDateofBirth | GWOccupation | GWAddressType | GWStatus | GWAddress | AccountNumber | GW_UserName | GW_Password | PolicyStatus | Activities                     | TermsAndConditions | PCActivities |
                | QP                     | desktop    |            | Chrome      |                 | Golden7   | NonSTP   | 24 Jewelers Park Dr |           | Neenah | Wisconsin | 54956          | Yes              | 9205352871  | rparas@jminsure.com | Email             | Female | No                    | Yes                      | Yes           | No               | currentdate   | TW144        | Yes                 |                      | Agency Express       | REGISTRY         | 07/01/1966    |              | Home          | Active   | REGISTRY  | REGISTRY      | su          | gw          | Quoted       | Approval Needed - Prior Losses | No                 |              |
