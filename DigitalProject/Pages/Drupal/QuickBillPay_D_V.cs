...
namespace DigitalProject.Pages.Drupal
{
    public class QuickBillPay_D_V
    {
        ...
        // Contact Header
        public string txtHeaderGetInTouchS = "GET IN TOUCH";
        public string txtTitleProud = "Proud to call Neenah, Wisconsin home.";

        // QuickBillPay Information 
        public string lblQuickBillPay = "Quick Bill Pay";
        public string lblQuickBillPayDesc = "Pay your bill without logging in or creating an account.";
        public string lblLetsLookYouUp = "Let's look you up.";
        public string lblPersonalEmailAccounttext = "Email Address or Account Number";
        public string lbllastName = "Last Name";
        public string lblZipCode = "Zip/Postal Code";
        public string btnContinue = "csu@jminsure.com";
        public string txtLogInHere = "Need to make more changes? Log in here";
        public string lblWhereDoIFindInfo = "Where do I find this information?";
