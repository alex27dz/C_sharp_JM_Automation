...
{
    class Crownandcaliber_D : Page
    {
        // Elements  

        // Crownandcaliber Page Images
        ...
        // Get Covered Fast
        string iconCompanyCSS = "[alt='Crown & Caliber']";
        ...
        Crownandcaliber_D_V Crownandcaliber_D_V = new Crownandcaliber_D_V();
        public Crownandcaliber_D(IWebDriver driver) : base(driver)
        {
        ...
        public void verifyPJHeader()
        {
            ...
            Assert.AreEqual(HeaderInsurance, Crownandcaliber_D_V.txtHeaderInsurance, "The Text doesn't match");

            string InfoProtect = driver.FindElement(By.CssSelector(infoProtectCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoProtect, Crownandcaliber_D_V.txtinfoProtect, "The Text doesn't match");
        ...
        public void verifyWhatsCovered()
        {
            ...
            Assert.AreEqual(TitleGetCoveredFast, Crownandcaliber_D_V.txtTitleGetCoveredFast, "The Text doesn't match");

            string InfoGetCoveredFast = driver.FindElement(By.CssSelector(infoGetCoveredFastCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoGetCoveredFast, Crownandcaliber_D_V.txtInfoGetCoveredFast, "The Text doesn't match");

            string BtnGetMyQuote = driver.FindElement(By.CssSelector(btnGetMyQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnGetMyQuote, Crownandcaliber_D_V.btnGetMyQuote, "The Text doesn't match");

            string LinkStillWantAQuote = driver.FindElement(By.CssSelector(linkStillWantAQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(LinkStillWantAQuote, Crownandcaliber_D_V.hrefStillWantAQuote, "The Text doesn't match");

            string InfoArrow = driver.FindElement(By.CssSelector(infoArrowCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoArrow, Crownandcaliber_D_V.txtInfoArrow, "The Text doesn't match");
