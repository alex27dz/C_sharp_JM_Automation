...
{
    class EngagementRingInsurance_D_V
    {
        // Nav Bar
        ...
        public string btnStartQuoteNow = "FEATURED IN";
        public string txtFeaturedIn = "START QUOTE NOW";

        // What's covered?
        public string txtHeaderWhatsCovered = "What's covered?";
        ...
        public string txtTitleDamageSS = "Damage";
        ...
        public string txtTitleWare = "War & Authority";
        ...
        public string txtInfoCrittersf = "Damage from vermin, rodents or insects isn't covered. So if a moth infestation affects the heirlooms in your attic, you couldn't file a claim for that.";
        ...
        public string txtHeaderPolicyholders = "What Our Policyholders Say";
