...
{
    class BlueNile_D : Page
    {
        // Elements  

        // Blue Nile Page Images
        ...
        // Get Covered Fast
        string iconCompanyCSS = "[alt='Blue Nile']";
        ...
        BlueNile_D_V BlueNile_D_V = new BlueNile_D_V();
        public BlueNile_D(IWebDriver driver) : base(driver)
        {
        ...
        public void verifyPJHeader()
        {
            ...
            Assert.AreEqual(HeaderInsurance, BlueNile_D_V.txtHeaderInsurance, "The Text doesn't match");

            string InfoProtect = driver.FindElement(By.CssSelector(infoProtectCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoProtect, BlueNile_D_V.txtinfoProtect, "The Text doesn't match");
        ...
        public void verifyWhatsCovered()
        {
            ...
            Assert.AreEqual(TitleGetCoveredFast, BlueNile_D_V.txtTitleGetCoveredFast, "The Text doesn't match");

            string InfoGetCoveredFast = driver.FindElement(By.CssSelector(infoGetCoveredFastCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoGetCoveredFast, BlueNile_D_V.txtInfoGetCoveredFast, "The Text doesn't match");

            string BtnGetMyQuote = driver.FindElement(By.CssSelector(btnGetMyQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnGetMyQuote, BlueNile_D_V.btnGetMyQuote, "The Text doesn't match");

            string LinkStillWantAQuote = driver.FindElement(By.CssSelector(linkStillWantAQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(LinkStillWantAQuote, BlueNile_D_V.hrefStillWantAQuote, "The Text doesn't match");

            string InfoArrow = driver.FindElement(By.CssSelector(infoArrowCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoArrow, BlueNile_D_V.txtInfoArrow, "The Text doesn't match");
