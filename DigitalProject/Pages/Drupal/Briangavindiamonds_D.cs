...
{
    class Briangavindiamonds_D : Page
    {
        // Elements  

        // BrianGavinDiamonds Page Images
        ...
        // Get Covered Fast
        string iconCompanyCSS = "[alt='Brian Gavin Diamonds']";
        ...
        Briangavindiamonds_D_V Briangavindiamonds_D_V = new Briangavindiamonds_D_V();
        public Briangavindiamonds_D(IWebDriver driver) : base(driver)
        {
        ...
        public void verifyPJHeader()
        {
            ...
            Assert.AreEqual(HeaderInsurance, Briangavindiamonds_D_V.txtHeaderInsurance, "The Text doesn't match");

            string InfoProtect = driver.FindElement(By.CssSelector(infoProtectCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoProtect, Briangavindiamonds_D_V.txtinfoProtect, "The Text doesn't match");
        ...
        public void verifyWhatsCovered()
        {
            ...
            Assert.AreEqual(TitleGetCoveredFast, Briangavindiamonds_D_V.txtTitleGetCoveredFast, "The Text doesn't match");

            string InfoGetCoveredFast = driver.FindElement(By.CssSelector(infoGetCoveredFastCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoGetCoveredFast, Briangavindiamonds_D_V.txtInfoGetCoveredFast, "The Text doesn't match");

            string BtnGetMyQuote = driver.FindElement(By.CssSelector(btnGetMyQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnGetMyQuote, Briangavindiamonds_D_V.btnGetMyQuote, "The Text doesn't match");

            string LinkStillWantAQuote = driver.FindElement(By.CssSelector(linkStillWantAQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(LinkStillWantAQuote, Briangavindiamonds_D_V.hrefStillWantAQuote, "The Text doesn't match");

            string InfoArrow = driver.FindElement(By.CssSelector(infoArrowCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoArrow, Briangavindiamonds_D_V.txtInfoArrow, "The Text doesn't match");
