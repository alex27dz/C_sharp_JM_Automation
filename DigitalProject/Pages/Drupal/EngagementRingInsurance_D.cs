...
{
    class EngagementRingInsurance_D : Page
    {
        //Elements

        // Engagement Ring Page Images
        ...
        string iconFeaturedInCSS = ".hero__tout";

        // What's covered?
        string headerWhatsCoveredCSS = ".spacing.title-row > h2";
        string infoWhatsCoveredCSS = ".spacing.title-row p";
        ...
        EngagementRingInsurance_D_V EngagementRingInsurance_D_V = new EngagementRingInsurance_D_V();
        public EngagementRingInsurance_D(IWebDriver driver) : base(driver)
        {
        ...
        {// Add all the elements you want to verify
            ...
            VerifyUIElementIsDisplayed(iconFeaturedInCSS);
        ...
        public void verifyNavBar()
        {
            ...
            Assert.AreEqual(NavPersonal, EngagementRingInsurance_D_V.hrefPersonal, "The Text doesn't match");

            string NavPersonalInsurance = driver.FindElement(By.CssSelector(navPersonalInsuranceCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavPersonalInsurance, EngagementRingInsurance_D_V.hrefPersonalInsurance, "The Text doesn't match");

            string NavGetAQuote = driver.FindElement(By.CssSelector(navGetAQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavGetAQuote, EngagementRingInsurance_D_V.hrefGetAQuote, "The Text doesn't match");

            string NavClaims = driver.FindElement(By.CssSelector(navClaimsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavClaims, EngagementRingInsurance_D_V.hrefClaims, "The Text doesn't match");

            string NavFAQ = driver.FindElement(By.CssSelector(navFAQCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavFAQ, EngagementRingInsurance_D_V.hrefFAQ, "The Text doesn't match");

            string NavPLBlog = driver.FindElement(By.CssSelector(navPLBlogCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavPLBlog, EngagementRingInsurance_D_V.hrefPLBlog, "The Text doesn't match");

            string NavPLPayMyBill = driver.FindElement(By.CssSelector(navPLPayMyBillCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavPLPayMyBill, EngagementRingInsurance_D_V.hrefPLPayMyBill, "The Text doesn't match");

            string NavManageMyPolicy = driver.FindElement(By.CssSelector(navManageMyPolicyCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavManageMyPolicy, EngagementRingInsurance_D_V.hrefManageMyPolicy, "The Text doesn't match");

            //Business
            string NavBusiness = driver.FindElement(By.CssSelector(navBusinessCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavBusiness, EngagementRingInsurance_D_V.hrefBusiness, "The Text doesn't match");

            string NavJewelryBusiness = driver.FindElement(By.CssSelector(navJewelryBusinessCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavJewelryBusiness, EngagementRingInsurance_D_V.hrefJewelryBusiness, "The Text doesn't match");

            string NavShipping = driver.FindElement(By.CssSelector(navShippingCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavShipping, EngagementRingInsurance_D_V.hrefShipping, "The Text doesn't match");

            string NavPawnbrokers = driver.FindElement(By.CssSelector(navPawnbrokersCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavPawnbrokers, EngagementRingInsurance_D_V.hrefPawnbrokers, "The Text doesn't match");

            string NavJMUniversity = driver.FindElement(By.CssSelector(navJMUniversityCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavJMUniversity, EngagementRingInsurance_D_V.hrefJMUniversity, "The Text doesn't match");

            string NavJewelerPrograms = driver.FindElement(By.CssSelector(navJewelerProgramsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavClaims, EngagementRingInsurance_D_V.hrefJewelerPrograms, "The Text doesn't match");

            string NavCLBlog = driver.FindElement(By.CssSelector(navCLBlogCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavCLBlog, EngagementRingInsurance_D_V.hrefCLBlog, "The Text doesn't match");

            string NavCLPayMyBill = driver.FindElement(By.CssSelector(navCLPayMyBillCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavCLPayMyBill, EngagementRingInsurance_D_V.hrefCLPAyMyBill, "The Text doesn't match");

            //About Us
            string NavAboutUsMenu = driver.FindElement(By.CssSelector(navAboutUsMenuCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavAboutUsMenu, EngagementRingInsurance_D_V.hrefAboutUsMenu, "The Text doesn't match");

            string NavAboutUs = driver.FindElement(By.CssSelector(navAboutUsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavAboutUs, EngagementRingInsurance_D_V.hrefAboutUs, "The Text doesn't match");

            string NavSocialResponsibility = driver.FindElement(By.CssSelector(navSocialResponsibilityCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavSocialResponsibility, EngagementRingInsurance_D_V.hrefSocialResponsibilty, "The Text doesn't match");

            string NavCareers = driver.FindElement(By.CssSelector(navCareersCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavPawnbrokers, EngagementRingInsurance_D_V.hrefCareers, "The Text doesn't match");

            //Log In
            string NavLogIn = driver.FindElement(By.CssSelector(navLogInCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavLogIn, EngagementRingInsurance_D_V.hrefLogIn, "The Text doesn't match");

            string NavPersonalJewelry = driver.FindElement(By.CssSelector(navPersonalJewelryCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavPersonalJewelry, EngagementRingInsurance_D_V.hrefPersonalJewelry, "The Text doesn't match");

            string NavAgent = driver.FindElement(By.CssSelector(navAgentCSS)).GetAttribute("InnerText");
            Assert.AreEqual(NavAgent, EngagementRingInsurance_D_V.hrefAgent, "The Text doesn't match");
        }
        public void verifyFooter()
        {
            //Footer
            string FtContact = driver.FindElement(By.CssSelector(ftContactCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtContact, EngagementRingInsurance_D_V.hrefContact, "The Text doesn't match");

            string FtPrivacyPolicy = driver.FindElement(By.CssSelector(ftPrivacyPolicyCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtPrivacyPolicy, EngagementRingInsurance_D_V.hrefPrivacyPolicy, "The Text doesn't match");

            string FtTermsofUse = driver.FindElement(By.CssSelector(ftTermsofUseCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtTermsofUse, EngagementRingInsurance_D_V.hrefTermsofUse, "The Text doesn't match");

            string FtShareYourConcerns = driver.FindElement(By.CssSelector(ftShareYourConcernsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtShareYourConcerns, EngagementRingInsurance_D_V.hrefShareYourConcern, "The Text doesn't match");

            string FtCareers = driver.FindElement(By.CssSelector(ftCareersCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtCareers, EngagementRingInsurance_D_V.hrefFTCareers, "The Text doesn't match");

            string FtNewsroom = driver.FindElement(By.CssSelector(ftNewsroomCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtNewsroom, EngagementRingInsurance_D_V.hrefNewesroom, "The Text doesn't match");

            string FtCoverageDisclaimer = driver.FindElement(By.CssSelector(ftCoverageDisclaimerCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtCoverageDisclaimer, EngagementRingInsurance_D_V.txtCoverageDisclaimer, "The Text doesn't match");

            string FtCopyrightYear = driver.FindElement(By.CssSelector(ftCopyrightYearCSS)).GetAttribute("InnerText");
            Assert.AreEqual(FtCopyrightYear, EngagementRingInsurance_D_V.txtCopyrightYear, "The Text doesn't match");
        }
        ...
        public void verifyReady()
        {
            ...
            Assert.AreEqual(HeaderReady, EngagementRingInsurance_D_V.txtHeaderReady, "The Text doesn't match");

            string TitleThreeSteps = driver.FindElement(By.CssSelector(titleThreeStepsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleThreeSteps, EngagementRingInsurance_D_V.txtTitleThreeSteps, "The Text doesn't match");

            string BtnStartQuoteNow = driver.FindElement(By.CssSelector(btnStartQuoteNowCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnStartQuoteNow, EngagementRingInsurance_D_V.btnStartQuoteNow, "The Text doesn't match");

            string IconFeaturedIn = driver.FindElement(By.CssSelector(iconFeaturedInCSS)).GetAttribute("InnerText");
            Assert.AreEqual(IconFeaturedIn, EngagementRingInsurance_D_V.txtFeaturedIn, "The Text doesn't match");
        ...
        public void verifyWhatsCovered()
        {
            ...
            Assert.AreEqual(HeaderWhatsCovered, EngagementRingInsurance_D_V.txtHeaderWhatsCovered, "The Text doesn't match");

            string InfoWhatsCovered = driver.FindElement(By.CssSelector(infoWhatsCoveredCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWhatsCovered, EngagementRingInsurance_D_V.txtInfoWhatsCovered, "The Text doesn't match");

            string TitleLoss = driver.FindElement(By.CssSelector(titleLossCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleLoss, EngagementRingInsurance_D_V.txtTitleLoss, "The Text doesn't match");

            string InfoLoss = driver.FindElement(By.CssSelector(infoLossCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoLoss, EngagementRingInsurance_D_V.txtInfoLoss, "The Text doesn't match");

            string TitleTheft = driver.FindElement(By.CssSelector(titleTheftCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleTheft, EngagementRingInsurance_D_V.txtTitleTheft, "The Text doesn't match");

            string InfoTheft = driver.FindElement(By.CssSelector(infoTheftCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoTheft, EngagementRingInsurance_D_V.txtInfoTheft, "The Text doesn't match");

            string TitleDamage = driver.FindElement(By.CssSelector(titleDamageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDamage, EngagementRingInsurance_D_V.txtTitleDamageSS, "The Text doesn't match");

            string InfoDamage = driver.FindElement(By.CssSelector(infoDamageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDamage, EngagementRingInsurance_D_V.txtInfoDamage, "The Text doesn't match");

            string TitleDisappearance = driver.FindElement(By.CssSelector(titleDisappearanceCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDisappearance, EngagementRingInsurance_D_V.txtTitleDisappearance, "The Text doesn't match");

            string InfoDisappearance = driver.FindElement(By.CssSelector(infoDisappearanceCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDisappearance, EngagementRingInsurance_D_V.txtInfoDisappearance, "The Text doesn't match");

            string TitleWorldWideCoverage = driver.FindElement(By.CssSelector(titleWorldWideCoverageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleWorldWideCoverage, EngagementRingInsurance_D_V.txtTitleWorldWideCoverage, "The Text doesn't match");

            string InfoWorldWideCoverage = driver.FindElement(By.CssSelector(infoWorldWideCoverageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWorldWideCoverage, EngagementRingInsurance_D_V.txtInfoWorldWideCoverage, "The Text doesn't match");
        }
        ...
        public void verifyNotCovered()
        {
            ...
            Assert.AreEqual(HeaderWhatnotCovered, EngagementRingInsurance_D_V.txtHeaderWhatnotCovered, "The Text doesn't match");

            string TitleWare = driver.FindElement(By.CssSelector(titleWareCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleWare, EngagementRingInsurance_D_V.txtTitleWare, "The Text doesn't match");

            string InfoWar = driver.FindElement(By.CssSelector(infoWarCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWar, EngagementRingInsurance_D_V.txtInfoWar, "The Text doesn't match");

            string TitleDeterioration = driver.FindElement(By.CssSelector(titleDeteriorationCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDeterioration, EngagementRingInsurance_D_V.txtTitleDeterioration, "The Text doesn't match");

            string InfoDeterioration = driver.FindElement(By.CssSelector(infoDeteriorationCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDeterioration, EngagementRingInsurance_D_V.txtInfoDeterioration, "The Text doesn't match");

            string TitleIntentionalActions = driver.FindElement(By.CssSelector(titleIntentionalActionsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleIntentionalActions, EngagementRingInsurance_D_V.txtTitleIntentionalActions, "The Text doesn't match");

            string InfoIntentionalActions = driver.FindElement(By.CssSelector(infoIntentionalActionsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoIntentionalActions, EngagementRingInsurance_D_V.txtInfoIntentionalActions, "The Text doesn't match");

            string TitleCritters = driver.FindElement(By.CssSelector(titleCrittersCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleCritters, EngagementRingInsurance_D_V.txtTitleCritters, "The Text doesn't match");

            string InfoCrittersf = driver.FindElement(By.CssSelector(infoCrittersfCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoCrittersf, EngagementRingInsurance_D_V.txtInfoCrittersf, "The Text doesn't match");
        }
        ...
        public void verifyHomeowners()
        {
            ...
            Assert.AreEqual(HeaderHomeowners, EngagementRingInsurance_D_V.txtHeaderHomeowners, "The Text doesn't match");

            string InfoHomeowners = driver.FindElement(By.CssSelector(infoHomeownersCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoHomeowners, EngagementRingInsurance_D_V.txtInfoHomeowners, "The Text doesn't match");
        }
        ...
        public void verifyPolicyholders()
        {
            ...
            Assert.AreEqual(HeaderPolicyholders, EngagementRingInsurance_D_V.txtHeaderPolicyholders, "The Text doesn't match");
        }
        ...
        public void verifyQuestions()
        {
            ...
            Assert.AreEqual(HeaderQuestions, EngagementRingInsurance_D_V.txtHeaderQuestions, "The Text doesn't match");

            string TitleWhoisJM = driver.FindElement(By.CssSelector(titleWhoisJMCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleWhoisJM, EngagementRingInsurance_D_V.txtTitleWhoisJM, "The Text doesn't match");

            string InfoWhoeisJM = driver.FindElement(By.CssSelector(infoWhoeisJMCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWhoeisJM, EngagementRingInsurance_D_V.txtInfoWhoeisJM, "The Text doesn't match");

            string TitleInsuranceWork = driver.FindElement(By.CssSelector(titleInsuranceWorkCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleInsuranceWork, EngagementRingInsurance_D_V.txtTitleInsuranceWork, "The Text doesn't match");

            string InfoInsuranceWork1 = driver.FindElement(By.CssSelector(infoInsuranceWork1CSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoInsuranceWork1, EngagementRingInsurance_D_V.txtInfoInsuranceWork1, "The Text doesn't match");

            string InfoInsuranceWork2 = driver.FindElement(By.CssSelector(infoInsuranceWork2CSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoInsuranceWork2, EngagementRingInsurance_D_V.txtInfoInsuranceWork2, "The Text doesn't match");

            string TitleCost = driver.FindElement(By.CssSelector(titleCostCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleCost, EngagementRingInsurance_D_V.txtTitleCost, "The Text doesn't match");

            string InfoCost = driver.FindElement(By.CssSelector(infoCostCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoCost, EngagementRingInsurance_D_V.txtInfoCost, "The Text doesn't match");
        ...
        public void verifyDownToTrust()
        {
            ...
            Assert.AreEqual(HeaderTrust, EngagementRingInsurance_D_V.txtHeaderTrust, "The Text doesn't match");

            string InfoTrust = driver.FindElement(By.CssSelector(infoTrustCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoTrust, EngagementRingInsurance_D_V.txtInfoTrust, "The Text doesn't match");

            string BtnDownload = driver.FindElement(By.CssSelector(btnDownloadCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnDownload, EngagementRingInsurance_D_V.btnDownload, "The Text doesn't match");
