...
namespace DigitalProject.Pages.Drupal
{
    class Briangavindiamonds_D_V
    {
        ...
        public string txtHeaderInsurance = "PERSONAL JEWELRY";
        public string txtinfoProtect = "Protect your jewelry for all its worth.";

        // Get Covered Fast
        public string txtTitleGetCoveredFast = "Get Covered Fast";
        public string txtInfoGetCoveredFast = "Insuring your Brian Gavin Diamonds jewelry with us is quick and simple. We provide the coverage you need against theft, mysterious disappearance, loss and damage.";
        public string btnGetMyQuote = "GET MY QUOTE";
        public string hrefStillWantAQuote = "My jewelry's not from Brian Gavin Diamonds, but I still want a quote.";
        public string txtInfoArrow = " »";
