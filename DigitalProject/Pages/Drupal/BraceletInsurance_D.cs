...
{
    class BraceletInsurance_D : Page
     {
        //Elements

        // Bracelet Insurance Page Images
        ...
        BraceletInsurance_D_V BraceletInsurance_D_V = new BraceletInsurance_D_V();
        public BraceletInsurance_D(IWebDriver driver) : base(driver)
        {
        ...
        public void verifyReady()
        {
            ...
            Assert.AreEqual(HeaderReady, BraceletInsurance_D_V.txtHeaderReady, "The Text doesn't match");

            string TitleThreeSteps = driver.FindElement(By.CssSelector(titleThreeStepsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleThreeSteps, BraceletInsurance_D_V.txtTitleThreeSteps, "The Text doesn't match");

            string BtnStartQuoteNow = driver.FindElement(By.CssSelector(btnStartQuoteNowCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnStartQuoteNow, BraceletInsurance_D_V.btnCalculateMyRate, "The Text doesn't match");
        ...
        public void verifyWhatsCovered()
        {
            ...
            Assert.AreEqual(HeaderWhatsCovered, BraceletInsurance_D_V.txtHeaderWhatsCovered, "The Text doesn't match");

            string InfoWhatsCovered = driver.FindElement(By.CssSelector(infoWhatsCoveredCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWhatsCovered, BraceletInsurance_D_V.txtInfoWhatsCovered, "The Text doesn't match");

            string TitleDamage = driver.FindElement(By.CssSelector(titleDamageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDamage, BraceletInsurance_D_V.txtTitleDamage, "The Text doesn't match");

            string InfoDamage = driver.FindElement(By.CssSelector(infoDamageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDamage, BraceletInsurance_D_V.txtInfoDamage, "The Text doesn't match");

            string TitleDisappearance = driver.FindElement(By.CssSelector(titleDisappearanceCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDisappearance, BraceletInsurance_D_V.txtTitleDisappearance, "The Text doesn't match");

            string InfoDisappearance = driver.FindElement(By.CssSelector(infoDisappearanceCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDisappearance, BraceletInsurance_D_V.txtInfoDisappearance, "The Text doesn't match");

            string TitleLoss = driver.FindElement(By.CssSelector(titleLossCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDamage, BraceletInsurance_D_V.txtTitleLoss, "The Text doesn't match");

            string InfoLoss = driver.FindElement(By.CssSelector(infoLossCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDamage, BraceletInsurance_D_V.txtInfoLoss, "The Text doesn't match");

            string TitleTheft = driver.FindElement(By.CssSelector(titleTheftCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDisappearance, BraceletInsurance_D_V.txtTitleTheft, "The Text doesn't match");

            string InfoTheft = driver.FindElement(By.CssSelector(infoTheftCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDisappearance, BraceletInsurance_D_V.txtInfoTheft, "The Text doesn't match");

            string TitleWorldWideCoverage = driver.FindElement(By.CssSelector(titleWorldWideCoverageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleWorldWideCoverage, BraceletInsurance_D_V.txtTitleWorldWideCoverage, "The Text doesn't match");

            string InfoWorldWideCoverage = driver.FindElement(By.CssSelector(infoWorldWideCoverageCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWorldWideCoverage, BraceletInsurance_D_V.txtInfoWorldWideCoverage, "The Text doesn't match");
        }
        ...
        public void verifyNotCovered()
        {
            ...
            Assert.AreEqual(HeaderWhatnotCovered, BraceletInsurance_D_V.txtHeaderWhatnotCovered, "The Text doesn't match");

            string TitleCritters = driver.FindElement(By.CssSelector(titleCrittersCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleCritters, BraceletInsurance_D_V.txtTitleCritters, "The Text doesn't match");

            string InfoCrittersf = driver.FindElement(By.CssSelector(infoCrittersfCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoCrittersf, BraceletInsurance_D_V.txtInfoCritters, "The Text doesn't match");

            string TitleDeterioration = driver.FindElement(By.CssSelector(titleDeteriorationCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleDeterioration, BraceletInsurance_D_V.txtTitleDeterioration, "The Text doesn't match");

            string InfoDeterioration = driver.FindElement(By.CssSelector(infoDeteriorationCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoDeterioration, BraceletInsurance_D_V.txtInfoDeterioration, "The Text doesn't match");

            string TitleIntentionalActions = driver.FindElement(By.CssSelector(titleIntentionalActionsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleIntentionalActions, BraceletInsurance_D_V.txtTitleIntentionalActions, "The Text doesn't match");

            string InfoIntentionalActions = driver.FindElement(By.CssSelector(infoIntentionalActionsCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoIntentionalActions, BraceletInsurance_D_V.txtInfoIntentionalActions, "The Text doesn't match");

            string TitleWare = driver.FindElement(By.CssSelector(titleWareCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleWare, BraceletInsurance_D_V.txtTitleWar, "The Text doesn't match");

            string InfoWar = driver.FindElement(By.CssSelector(infoWarCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWar, BraceletInsurance_D_V.txtInfoWar, "The Text doesn't match");
        }
        ...
        public void verifyHomeowners()
        {
            ...
            Assert.AreEqual(HeaderHomeowners, BraceletInsurance_D_V.txtHeaderHomeowners, "The Text doesn't match");

            string InfoHomeowners = driver.FindElement(By.CssSelector(infoHomeownersCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoHomeowners, BraceletInsurance_D_V.txtInfoHomeowners, "The Text doesn't match");
        }
        ...
        public void verifyQuestions()
        {
            ...
            Assert.AreEqual(HeaderQuestions, BraceletInsurance_D_V.txtHeaderQuestions, "The Text doesn't match");

            string TitleWhoisJM = driver.FindElement(By.CssSelector(titleWhoisJMCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleWhoisJM, BraceletInsurance_D_V.txtTitleWhoisJM, "The Text doesn't match");

            string InfoWhoeisJM = driver.FindElement(By.CssSelector(infoWhoeisJMCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoWhoeisJM, BraceletInsurance_D_V.txtInfoWhoeisJM, "The Text doesn't match");

            string TitleInsuranceWork = driver.FindElement(By.CssSelector(titleInsuranceWorkCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleInsuranceWork, BraceletInsurance_D_V.txtTitleInsuranceWork, "The Text doesn't match");

            string InfoInsuranceWork1 = driver.FindElement(By.CssSelector(infoInsuranceWork1CSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoInsuranceWork1, BraceletInsurance_D_V.txtInfoInsuranceWork1, "The Text doesn't match");

            string InfoInsuranceWork2 = driver.FindElement(By.CssSelector(infoInsuranceWork2CSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoInsuranceWork2, BraceletInsurance_D_V.txtInfoInsuranceWork2, "The Text doesn't match");

            string TitleCost = driver.FindElement(By.CssSelector(titleCostCSS)).GetAttribute("InnerText");
            Assert.AreEqual(TitleCost, BraceletInsurance_D_V.txtTitleCost, "The Text doesn't match");

            string InfoCost = driver.FindElement(By.CssSelector(infoCostCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoCost, BraceletInsurance_D_V.txtInfoCost, "The Text doesn't match");
        ...
        public void verifyDownToTrust()
        {
            ...
            Assert.AreEqual(HeaderTrust, BraceletInsurance_D_V.txtHeaderTrust, "The Text doesn't match");

            string InfoTrust = driver.FindElement(By.CssSelector(infoTrustCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoTrust, BraceletInsurance_D_V.txtInfoTrust, "The Text doesn't match");

            string BtnDownload = driver.FindElement(By.CssSelector(btnDownloadCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnDownload, BraceletInsurance_D_V.btnDownload, "The Text doesn't match");
