...
namespace DigitalProject.Pages.Drupal
{
    class Whiteflash_D_V
    {
        ...
        public string txtInfoGetCoveredFast = "Insuring your Whiteflash jewelry with us is quick and simple. We provide the coverage you need against theft, mysterious disappearance, loss and damage.";
        public string btnGetMyQuote = "GET MY QUOTE";
        public string hrefStillWantAQuote = "My jewelry's not from Whiteflash, but I still want a quote.";
