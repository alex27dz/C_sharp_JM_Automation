...
{
    class Whiteflash_D : Page
    {
        // Elements  

        // Whiteflash Page Images
        ...
        Whiteflash_D_V Whiteflash_D_V = new Whiteflash_D_V();
        public Whiteflash_D(IWebDriver driver) : base(driver)
        {
        ...
        public void verifyPJHeader()
        {
            ...
            Assert.AreEqual(HeaderInsurance, Whiteflash_D_V.txtHeaderInsurance, "The Text doesn't match");

            string InfoProtect = driver.FindElement(By.CssSelector(infoProtectCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoProtect, Whiteflash_D_V.txtinfoProtect, "The Text doesn't match");
        ...
        public void verifyWhatsCovered()
        {
            ...
            Assert.AreEqual(TitleGetCoveredFast, Whiteflash_D_V.txtTitleGetCoveredFast, "The Text doesn't match");

            string InfoGetCoveredFast = driver.FindElement(By.CssSelector(infoGetCoveredFastCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoGetCoveredFast, Whiteflash_D_V.txtInfoGetCoveredFast, "The Text doesn't match");

            string BtnGetMyQuote = driver.FindElement(By.CssSelector(btnGetMyQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnGetMyQuote, Whiteflash_D_V.btnGetMyQuote, "The Text doesn't match");

            string LinkStillWantAQuote = driver.FindElement(By.CssSelector(linkStillWantAQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(LinkStillWantAQuote, Whiteflash_D_V.hrefStillWantAQuote, "The Text doesn't match");

            string InfoArrow = driver.FindElement(By.CssSelector(infoArrowCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoArrow, Whiteflash_D_V.txtInfoArrow, "The Text doesn't match");
        }
    }
}
