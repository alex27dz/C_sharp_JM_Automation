...
namespace DigitalProject.Pages.Drupal
{
    class BlueNile_D_V
    {
        ...
        public string txtInfoGetCoveredFast = "Insuring your Blue Nile jewelry with us is quick and simple. We provide the coverage you need against theft, mysterious disappearance, loss and damage.";
        public string btnGetMyQuote = "GET MY QUOTE";
        public string hrefStillWantAQuote = "My jewelry's not from Blue Nile, but I still want a quote.";
