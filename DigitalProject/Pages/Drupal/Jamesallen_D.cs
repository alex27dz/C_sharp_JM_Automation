...
{
    class Jamesallen_D : Page
    {
        // Elements  

        // James Allen Page Images
        ...
        // Get Covered Fast
        string iconCompanyCSS = "[alt='James Allen logo']";
        ...
        Jamesallen_D_V Jamesallen_D_V = new Jamesallen_D_V();
        public Jamesallen_D(IWebDriver driver) : base(driver)
        {
        ...
        public void verifyPJHeader()
        {
            ...
            Assert.AreEqual(HeaderInsurance, Jamesallen_D_V.txtHeaderInsurance, "The Text doesn't match");

            string InfoProtect = driver.FindElement(By.CssSelector(infoProtectCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoProtect, Jamesallen_D_V.txtinfoProtect, "The Text doesn't match");
        ...
        public void verifyWhatsCovered()
        {
            ...
            Assert.AreEqual(TitleGetCoveredFast, Jamesallen_D_V.txtTitleGetCoveredFast, "The Text doesn't match");

            string InfoGetCoveredFast = driver.FindElement(By.CssSelector(infoGetCoveredFastCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoGetCoveredFast, Jamesallen_D_V.txtInfoGetCoveredFast, "The Text doesn't match");

            string BtnGetMyQuote = driver.FindElement(By.CssSelector(btnGetMyQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(BtnGetMyQuote, Jamesallen_D_V.btnGetMyQuote, "The Text doesn't match");

            string LinkStillWantAQuote = driver.FindElement(By.CssSelector(linkStillWantAQuoteCSS)).GetAttribute("InnerText");
            Assert.AreEqual(LinkStillWantAQuote, Jamesallen_D_V.hrefStillWantAQuote, "The Text doesn't match");

            string InfoArrow = driver.FindElement(By.CssSelector(infoArrowCSS)).GetAttribute("InnerText");
            Assert.AreEqual(InfoArrow, Jamesallen_D_V.txtInfoArrow, "The Text doesn't match");
        }
    }
}
