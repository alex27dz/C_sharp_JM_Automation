...
{
    public class ManageMyPolicy_D : Page
    {
        //txtHeader
        ...
        //Main Contant
        public string txtContant1Xpath = "//h2[text()='Secure Login']";
        public string txtContant2Xpath = "//label[text()='Email']";
        public string txtContant3Xpath = "//a[text()='Forgot Account Email?']";
        public string txtContant4Xpath = "//label[text()='Password']";
        public string txtContant5Xpath = "//a[text()='Forgot your Password?']";
        public string txtContant6Xpath = "//h2[text()='Not Registered?']";
        public string txtContant7Xpath = "//span[text()='Questions?']";
        public string txtContant8Xpath = "//a[text()='888.884.2424']";
        public string txtContant9Xpath = "//input[@id='submitButton']";
        public string txtContant10Xpath = "//a[@id='registerButton']";
        public string txtContant11Xpath = "//h2[text()='Securely pay your bill without logging in']";
        public string txtContant12Xpath = "//a[@id='quickPayLinkLarge']";
        ...
        public string txtFooter4Xpath = "//p[contains(.,'© 2021 Jewelers Mutual Group. All Rights Reserved.')]";
        ...
        public ManageMyPolicy_D(IWebDriver driver) : base(driver)
        {
        ...
        public override void VerifyPage()
        {
            ...
            VerifyUIElementIsDisplayed(txtContant12Xpath);
        ...
        public void verifyMainContent()
        {
            ...
            Assert.AreEqual(txtContant1.ToLower().Trim(), ManageMyPolicy_D_v.txtContant1.ToLower().Trim(), "The Text doesn't match");

            string txtContant2 = driver.FindElement(By.XPath(txtContant2Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant2.ToLower().Trim(), ManageMyPolicy_D_v.txtContant2.ToLower().Trim(), "The Text doesn't match");

            string txtContant3 = driver.FindElement(By.XPath(txtContant3Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant3.ToLower().Trim(), ManageMyPolicy_D_v.txtContant3.ToLower().Trim(), "The Text doesn't match");

            string txtContant4 = driver.FindElement(By.XPath(txtContant4Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant4.ToLower().Trim(), ManageMyPolicy_D_v.txtContant4.ToLower().Trim(), "The Text doesn't match");

            string txtContant5 = driver.FindElement(By.XPath(txtContant5Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant5.ToLower().Trim(), ManageMyPolicy_D_v.txtContant5.ToLower().Trim(), "The Text doesn't match");

            string txtContant6 = driver.FindElement(By.XPath(txtContant6Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant6.ToLower().Trim(), ManageMyPolicy_D_v.txtContant6.ToLower().Trim(), "The Text doesn't match");

            string txtContant7 = driver.FindElement(By.XPath(txtContant7Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant7.ToLower().Trim(), ManageMyPolicy_D_v.txtContant7.ToLower().Trim(), "The Text doesn't match");

            string txtContant8 = driver.FindElement(By.XPath(txtContant8Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant8.ToLower().Trim(), ManageMyPolicy_D_v.txtContant8.ToLower().Trim(), "The Text doesn't match");

            string txtContant9 = driver.FindElement(By.XPath(txtContant9Xpath)).GetAttribute("value");
            Assert.AreEqual(txtContant9.ToLower().Trim(), ManageMyPolicy_D_v.txtContant9.ToLower().Trim(), "The Text doesn't match");

            string txtContant10 = driver.FindElement(By.XPath(txtContant10Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant10.ToLower().Trim(), ManageMyPolicy_D_v.txtContant10.ToLower().Trim(), "The Text doesn't match");

            string txtContant11 = driver.FindElement(By.XPath(txtContant11Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant11.ToLower().Trim(), ManageMyPolicy_D_v.txtContant11.ToLower().Trim(), "The Text doesn't match");

            string txtContant12 = driver.FindElement(By.XPath(txtContant12Xpath)).GetAttribute("innerText");
            Assert.AreEqual(txtContant12.ToLower().Trim(), ManageMyPolicy_D_v.txtContant12.ToLower().Trim(), "The Text doesn't match");
