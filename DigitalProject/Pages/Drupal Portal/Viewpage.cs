...
namespace DigitalProject.Pages.Drupal_Portal
{
    ...
    {
        string btnViewXpath = "//a[text()='View']";
        ...
        {
            VerifyUIElementIsDisplayed(btnViewXpath);
        }

        public override void WaitForLoad()
        {
            WaitUntilElementVisible(driver, By.XPath(btnViewXpath));
            IsElementPresent(driver, By.XPath(btnViewXpath));
