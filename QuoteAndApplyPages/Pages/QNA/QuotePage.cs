...
namespace QuoteAndApplyPages.Pages.QNA
{
    public class QuotePage : Page
    {
        ...
        public void EnterZipCode(string Zipcode)
        {
            ...
            action.Perform();
            action.Release();
            WaitUntilElementVisible(driver, By.XPath("//div[@class='jm-input-valid display-inline'][@data-bind='visible: IsZipCodeValid']"));
        ...
        public void AddPartnerDetails(string FirstName, string LastName, string Phonenumber, string Email)
        {
            RegistryKey RegKey = Registry.CurrentUser.CreateSubKey(@"SOFTWARE\AutomationSelenium\Guidewire");
